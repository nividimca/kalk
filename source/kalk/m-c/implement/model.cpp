...
model::model(){
    checkS.push_back(new checkFraz() );
    checkS.push_back(new checkString() );
    checkS.push_back(new checkTriple() );
...
void model::changeCheck(int i){
    currentData = checkS[i];
    getFrazioni();
    emit sendChangedCheck();
}
